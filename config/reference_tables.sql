...
INSERT INTO rrr_type (code, rrr_group_type_code, display_value, is_primary, share_check, party_required, description, status, rrr_panel_code) VALUES ('caveat', 'restrictions', 'Caveat::::Арест::::القيود::::Caveat::::ሁኔታ', false, true, true, 'Extension to LADM::::Расширение LADM::::...::::Extension du LADM::::ወደ መአዶሞ ማስፋት', 'x', 'simpleRightholder');
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('varyCaveat', 'registrationServices', 'Vary caveat::::Изменить арест::::تعديل القيد::::Varier Caveat::::ሁኔታን አሻሽል', '...::::...::::...::::...::::...', 'x', 5, 5.00, 0.00, 0.00, 1, '<Caveat> <reference>', 'caveat', 'vary', 'property', NULL, NULL);
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('removeCaveat', 'registrationServices', 'Remove Caveat::::Снять ограничение::::...::::Supprimer Caveat::::ሁኔታ አንሳ', '...::::...::::...::::...::::...', 'x', 5, 5.00, 0.00, 0.00, 1, 'Caveat <reference> removed', 'caveat', 'cancel', 'property', NULL, NULL);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('caveat', 'registrationServices', 'Register Caveat::::Регистрация ареста::::تسجيل  قيد::::Enregistrer Caveat::::ሁኔታ መዝግብ', '...::::...::::...::::...::::...', 'x', 5, 50.00, 0.00, 0.00, 1, 'Caveat in the name of <name>', 'caveat', 'new', 'property', NULL, NULL);
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('recordStateLand', 'stateLandServices', 'Record New Property::::::::::::::::አዲስ ንብረት ሪኮርድ አድርግ', 'Create a new State Land Property::::::::::::::::አዲስ በመንግስት መሬት ላይ ያለ ንብረት አመንጭ', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'newSLProperty', 'property', 20);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('changeSLParcels', 'stateLandServices', 'Create or Change Parcels::::::::::::::::ቁራሽ መሬቶች አመንጭ ወይም ለውጥ', 'Create, change or dispose State Land Parcels::::::::::::::::የመንግስት ቁራሽ መሬቶች አመንጭ፤ ለውጥ ወይም አስተላልፍ', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'cadastreTransMap', 'parcels', 10);
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('removeRight', 'registrationServices', 'Remove Right (General)::::Прекратить право::::الغاء حق (عام)::::Supprimer Droit (Général)::::መብት አንሳ (አጠቃላይ)', '...::::...::::...::::...::::...', 'x', 5, 5.00, 0.00, 0.00, 1, '<right> <reference> cancelled', NULL, 'cancel', 'property', NULL, NULL);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('removeRestriction', 'registrationServices', 'Remove Restriction (General)::::Снять ограничение::::ازالة قيد::::Supprimer Restriction (Général)::::ገደብ አንሳ', '...::::...::::...::::...::::...', 'x', 5, 5.00, 0.00, 0.00, 1, '<restriction> <reference> cancelled', NULL, 'cancel', 'property', NULL, NULL);
...
INSERT INTO state_land_status_type (code, display_value, description, status) VALUES ('dormant', 'Dormant::::::::::::::::ለጊዜው ዘገምተኛ', 'The land is not being used for any purpose (e.g. it has been land banked)::::::::::::::::መሬቱ ለምንም አገልግሎት እየዋለ አይደለም (ምሣሌ የመሬት ባንክ ውስጥ የተካተተ ነው)', 'c');
...
INSERT INTO claim_status (code, display_value, status, description) VALUES ('unmoderated', 'Un-moderated::::::::::::::::አንሞደሬትድ', 'i', '');
INSERT INTO claim_status (code, display_value, status, description) VALUES ('challenged', 'Challenged::::::::::::::::ተቃውሞ ቀርቦበታል', 'i', '');
INSERT INTO claim_status (code, display_value, status, description) VALUES ('moderated', 'Moderated::::::::::::::::ሞደሬትድ', 'i', '');
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('caveat', 'Caveat::::Протест::::الموانع::::Caveat::::ሁኔታ', 'c', 'Extension to LADM::::Расширение LADM::::...::::Extension au LADM::::ወደ መአዶሞ ማስፋት', false);
...
INSERT INTO approle (code, display_value, status, description) VALUES ('removeRestriction', 'Service - Remove Restriction::::Service - Remove Restriction::::الخدمة-ازالة قيد::::Service - Supprimer Restriction::::የአገልግሎት - ገደብ አስወግድ', 'c', 'Registration Service. Allows the Remove Restriction service to be started. ::::Registration Service. Allows the Remove Restriction service to be started.::::Registration Service. Allows the Remove Restriction service to be started.::::Service Enregistrement. Permet au Service - Supprimer Restriction de commencer.::::የምዝገባ አገልግሎት - የገደብ አንሳ አገልግሎት ለመጀመር ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('ApplnCreate', 'Application - Lodge::::Application - Lodge::::جركة طلب-ايداع::::Demande - Déposer::::ማመልከቻ - አቅርብ', 'c', 'Allows new application details to be created (lodged). ::::Allows new application details to be created (lodged).::::Allows new application details to be created (lodged).::::Permet de créer les détails de la nouvelle demande (déposé).::::የአዲስ ማመልከቻ ዝርዝር ጉዳዮችን ለመፍጠር (ለማስገባት) ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('varyCaveat', 'Service - Vary Caveat::::Service - Vary Caveat::::الخدمة-تغيير مانع::::Service - Varier Caveat::::የአገልግሎት - ሁኔታ አሻሽል', 'c', 'Registration Service. Allows the Vary Caveat service to be started. ::::Registration Service. Allows the Vary Caveat service to be started.::::Registration Service. Allows the Vary Caveat service to be started.::::Service Enregistrement. Permet au Service - Varier Caveat de commencer.::::የምዝገባ አገልግሎት - የሁኔታ አሻሻል አገልግሎት ለመጀመር ይፈቅዳል');
INSERT INTO approle (code, display_value, status, description) VALUES ('caveat', 'Service - Register Caveat::::Service - Register Caveat::::الخدمة-تسجيل مانع::::Service - Enregistrement Caveat::::የአገልግሎት - ሁኔታ መዝገብ', 'c', 'Registration Service. Allows the Register Caveat service to be started. ::::Registration Service. Allows the Register Caveat service to be started.::::Registration Service. Allows the Register Caveat service to be started.::::Service Enregistrement. Permet au Service - Enregistrement Caveat de commencer.::::የምዝገባ አገልግሎት - የሁኔታ መዝግብ አገልግሎት ለመጀመር ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('PrintMap', 'Map - Print::::Map - Print::::الخارطة-طباعة::::Plan - Imprimer::::ካርታ ፕሪንት አድርግ', 'c', 'Allows the user to create printouts from the Map::::Allows the user to create printouts from the Map::::Allows the user to create printouts from the Map::::Permet à l''utilisateur de créer des plans à imprimer.::::ተጠቃሚውን ከካርታው ፕሪንት የሚደረጉ ጉዳዮችን ለመፍጠር ይጠቅማል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('removeRight', 'Service - Remove Right (General)::::Service - Remove Right (General)::::الخدمة- ازالة حق عام::::Service - Supprimer Droit (Général)::::የአገልግሎት - መብት አስወግድ (አጠቃላይ)', 'c', 'Registration Service. Allows the Remove Right (General) service to be started. ::::Registration Service. Allows the Remove Right (General) service to be started.::::Registration Service. Allows the Remove Right (General) service to be started.::::Service Enregistrement. Permet au Service - Supprimer Droit (Général) de commencer.::::የምዝገባ አገልግሎት - የመብት አንሳ (አጠቃላይ) አገልግሎት ለመጀመር ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('04SEC_Secret', 'Security - Secret::::::::::::::::ደህንነት - ሚስጢር', 'c', 'Grants user clearance to view and/or access all unrestricted, restricted, confidential and secret records.::::::::::::::::ሁሉንም ያልተገደቡ፤ የተገደቡ፤ ግላዊ ሚስጢር እና ምስጢራዊ ሪኮርዶች ለማየት እና/ወይም ለመጠቀም ፈቃድ ይሰጣል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('05SEC_TopSecret', 'Security - Top Secret::::::::::::::::ደህንነት - ጥብቅ ሚስጢር', 'c', 'Grants user clearance to view and/or access all records.::::::::::::::::ሁሉንም ሪኮርዶች ለማየት እና/ወይም ለመጠቀም ፈቃድ ይሰጣል');
INSERT INTO approle (code, display_value, status, description) VALUES ('ModerateClaim', 'Moderate claim::::::::::::::::የመብት ጥያቄ ሞደሬት አድርግ', 'c', 'Allows to moderate claims submitted by other community recorders.::::::::::::::::በሌሎች የማህበረሰብ መዝጋቢዎች የሚቀርቡ የመብት ጥያቄዎችን ለማስተባበር ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('AccessCS', 'Access Community Server::::::::::::::::የማሕበረሰብ ሰርቨር ተጠቀም', 'c', 'Allows to access Community Server as Community recorder user::::::::::::::::የማህበረሰብ ተጠቃሚ የሚመዘግብ የማሕበረሰብ ሰርቨር ለመጠቀም ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('maintainStateLand', 'Service - Maintain State Land::::::::::::::::የአገልግሎት - የመንግስት መሬት መረጃ ወቅታዊ አድርግ', 'c', 'State Land Service. Allows the Maintain State Land service to be started.::::::::::::::::የመንግስት መሬት አገልግሎት፤ የመንግስት መሬት መረጃ ወቅታው የማድረግ አገልግሎት ለመጀመር ይፈቅዳል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('ObjectionCommentEdit', 'Workflow - Edit Objection Comment::::::::::::::::የስራ ፍሰት - የተቃውሞ አስተያየቱን አርትዕ ', 'c', 'Allows the user to edit or remove all Timeline comments on an Objection task.::::::::::::::::ተጠቃሚውን የተቃዉሞ ተግባር ላይ የተሰጡ ሁሉንም የጊዜ ቅደም ተከተል አስተያየቶች ለማርተእ ወይም ለማጥፋት ይጠቅማል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('03SEC_Confidential', 'Security - Confidential::::::::::::::::ደህንነት - ግላዊ ሚስጢር', 'c', 'Grants user clearance to view and/or access all unrestricted, restricted and confidential records.::::::::::::::::ሁሉንም ያልተገደቡ፤ የተገደቡና ግላዊ ሚስጢር ሪኮርዶች ለማየት እና/ወይም ለመጠቀም ፈቃድ ይሰጣል');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('removeCaveat', 'Service - Remove Caveat::::Service - Remove Caveat::::الخدمة-ازالة مانع::::Service - Supprimer Caveat::::የአገልግሎት - ሁኔታ አስወግድ', 'c', 'Registration Service. Allows the Remove Caveat service to be started. ::::Registration Service. Allows the Remove Caveat service to be started.::::Registration Service. Allows the Remove Caveat service to be started.::::Service Enregistrement. Permet au Service - Supprimer Caveat de commencer.::::የምዝገባ አገልግሎት - የሁኔታ አንሳ አገልግሎት ለመጀመር ይፈቅዳል');
...
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('am-ET', 'ኣማርኛ', true, false, 5);
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('ru-RU', 'Русский::::::::::::::::የሩስያ', false, false, 2);
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('fr-FR', 'Français::::::::::::::::የፈረንሳይኛ', false, false, 4);
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('en-US', 'English::::::::::::::::የእንግሊዝኛ', true, true, 1);
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('ar-JO', 'عربي::::::::::::::::የአረብኛ', false, false, 3);
