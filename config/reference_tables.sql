...
INSERT INTO request_display_group (code, display_value, description, status) VALUES ('lease', 'Leases and Licenses', 'Lease and License display group', 'c');
INSERT INTO request_display_group (code, display_value, description, status) VALUES ('interest', 'Interests', 'Interests display group', 'c');
INSERT INTO request_display_group (code, display_value, description, status) VALUES ('claim', 'Claims', 'Claims display group', 'c');
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slLeaseCancel', 'stateLandServices', 'Cancel Lease', 'Cancel an existing lease.', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'lease', 'cancel', 'slProperty', 'lease', 90);
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slLease', 'stateLandServices', 'Record Lease', 'Record a new lease for an existing State Land Property', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'lease', 'new', 'slProperty', 'lease', 70);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slLicense', 'stateLandServices', 'Record License', 'Record a new license for an existing State Land Property', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'license', 'new', 'slProperty', 'lease', 100);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slLeaseChange', 'stateLandServices', 'Change Lease', 'Update the details of an existing lease', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'lease', 'vary', 'slProperty', 'lease', 80);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slLicenseChange', 'stateLandServices', 'Change License', 'Update the details of an existing license', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'license', 'vary', 'slProperty', 'lease', 110);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slLicenseCancel', 'stateLandServices', 'Cancel License', 'Cancel an existing license', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'license', 'cancel', 'slProperty', 'lease', 120);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slInterest', 'stateLandServices', 'Record Interest', 'Record a new interest over an existing State Land Property', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, NULL, 'new', 'slProperty', 'interest', 130);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slInterestChange', 'stateLandServices', 'Change Interest', 'Update the details of an existing interest', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, NULL, 'vary', 'slProperty', 'interest', 140);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('cancelInterest', 'stateLandServices', 'Cancel Interest', 'Cancel one or more interests on an existing State Land Property', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, 'cancel', 'slProperty', 'interest', 150);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slClaim', 'stateLandServices', 'Record Claim', 'Record a new claim affecting an existing State Land Property', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'claim', 'new', 'slProperty', 'claim', 160);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slClaimChange', 'stateLandServices', 'Change Claim', 'Update the details of an existing claim', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'claim', 'vary', 'slProperty', 'claim', 170);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slClaimCancel', 'stateLandServices', 'Cancel Claim', 'Cancel an existing claim', 'c', 5, 0.00, 0.00, 0.00, 1, NULL, 'claim', 'cancel', 'slProperty', 'claim', 180);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('checklist', 'stateLandServices', 'Checklist', 'Identifies a checklist of items to be completed for this Job', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'checklist', 'job', 190);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('publicDisplayMap', 'stateLandServices', 'Public Display Map', 'Generates a map of the job area for public display purposes', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'publicDisplayMap', 'job', 200);
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slNotify', 'stateLandServices', 'Manage Notifications', 'Used for generating and managing bulk notifications related to the job', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'slNotify', 'job', 220);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slNegotiate', 'stateLandServices', 'Manage Negotiations', 'Used for managing negotiations for property acquisition or disposal', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'slNegotiate', 'job', 230);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('slObjection', 'stateLandServices', 'Manage Objections', 'Records details of objections raised by parties affected by State Land activities', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'slObjection', 'job', 240);
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('idVerification', 'Proof of Identity', 'c', 'Extension to LADM::::Расширение LADM::::...::::Extension au LADM', false);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('objection', 'Objection', 'c', 'Extension to LADM::::Расширение LADM::::...::::Extension au LADM', false);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('publicNotification', 'Public Notification', 'c', 'Extension to LADM::::Расширение LADM::::...::::Extension au LADM', false);
...
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('fr-FR', 'French::::Французкий::::فرنسي::::Français', false, false, 4);
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('ar-JO', 'Arabic::::Арабский::::عربي::::Arabe', false, false, 3);
INSERT INTO language (code, display_value, active, is_default, item_order) VALUES ('ru-RU', 'Russian::::Русский::::الروسية::::Russe', false, false, 2);
