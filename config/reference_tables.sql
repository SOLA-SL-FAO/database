...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, display_group_name, service_panel_code) VALUES ('changeSLParcels', 'stateLandServices', 'Change State Land Parcels', 'Service to manually create or change State Land parcels', 'c', 5, 0.00, 0.00, 0.00, 0, NULL, NULL, NULL, 'General', 'cadastreTransMap');
