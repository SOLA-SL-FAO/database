...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-caveat', 'ba_unit-has-caveat', 'sql', 'Caveat should not prevent registration proceeding.::::Арест не должен ограничивать дальнейшую регистрацию.::::القيود لا يجب ان تعطل عملية التسجيل::::Un caveat ne doit pas empêcher de procéder à l''enregistrement.::::ሁኔታ ምዝገባ እንዳይቀጥል መከልከል የለበትም ', 'NOT USED BY SOLA STATE LAND', '#{id}(administrative.rrr.id) is requested.');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('service-check-no-previous-digital-title-service', 'service-check-no-previous-digital-title-service', 'sql', 'For the Convert Title service there must be no existing digital title record (including the recording of a primary (ownership) right) for the identified title::::Для услуги конвертации недвижимости не должно быть существующих записей этой недвижим.::::في خدمة تحويل الى سند  ملكية رقمي يجب ان لا يوجد  سجل رقمي للملكية بما فيه  تسجيل الحق الاساسي::::Pour le service de conversion de titre, il ne doit pas y avoir de titre numérique existant déjà enregistré (incluant l''enregistrement d''un droit principal (propriété) pour le titre identifié.::::የይዞታ መብት ማረጋገጫ ሰለድ ለውጥ አገልግሎት በአሁኑ ጊዜ የዲጂታል የይዞታ መብት ማርጋገጫ ሰነድ ሪኮርድ መኖር የለበትም (ለተለየው የይዞታ መብት ማርጋገጫ ሰነድ ዋና ባለሀብትነት መብት ሪኮርድንግን ጨምሮ)', 'NOT USED BY SOLA STATE LAND', '#{id}(application.service.id) is requested where service is for newDigitalTitle or newDigitalProperty');
