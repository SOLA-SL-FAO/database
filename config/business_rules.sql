...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-cadastre-object', 'BA030', 'sql', 'Property must have an associated parcel', NULL, '#{id}(administrative.ba_unit.id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba-unit-has-notes-to-action', 'BA110', 'sql', 'Notes on _$property_name require action; _$notes_list', 'State Land BR-6', 'Parameters: #{id} (administrative.ba_unit.id)');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-a-valid-primary-right', 'BA070', 'sql', '_$property_name must have one State Landholder interest or one Owner interest.', 'Updated for State Land BR-1', '#{id}(baunit_id) is requested.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba-unit-has-spatial-parcels', 'BA120', 'sql', 'Parcels on _$property_name have not been mapped; _$parcel_list', 'State Land BR-7', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba-unit-has-land-use', 'BA130', 'sql', '_$property_name must be linked to parcels that specify land use', 'State Land BR-11', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('cancel-title-check-rrr-cancelled', 'BA140', 'sql', 'All current interests on the property being disposed must be extinguished by this job', NULL, '#{id}(application_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-must-have-parties', 'RR040', 'sql', 'The _$rrr_type interest on _$property_name must have a rightholder specified', NULL, '');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('area-check-percentage-newofficialarea-calculatednewarea', 'CA140', 'sql', 'The difference between the official parcel area and its calculated area should be less than 1%; _$parcel_list', 'Updated for State Land BR-3', '#{id}(cadastre.cadastre_object.id) is requested. 
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('cadastre-object-check-name', 'CA250', 'sql', 'Parcel name(s) inconsistent with naming convention; _$parcel_list ', 'Updated for State Land BR-5', '#{id}(cadastre.cadastre_object.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('parcel-name-duplicated', 'CA260', 'sql', '_$rule_count duplicated parcel name(s); _$parcel_list', 'State Land BR-5', 'Parameters: #{id} (transaction.transaction.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-has-conditions', 'RR150', 'sql', '_$rrr_type on _$property_name should have conditions recorded', 'State Land BR-19', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('property-compenstation-comparison', 'VA010', 'sql', 'Final compenstation is more than %10 above the initial offer; _$property_list', 'State Land BR-9', 'Parameters: #{id} (application.service.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('newtitle-br24-check-rrr-accounted', 'newtitle-br24-check-rrr-accounted', 'sql', 'All rights and restrictions from existing title(s) must be accounted for in the new titles created in this application.::::Все права и ограничения существующих объектов недвижимости должны быть учтены в новых объектах недвижимости, создаваемых в этом заявлении.::::جميع الحقوق او القيود من السندات الحالية يجب مراعاتها في  السندات الجديدة::::Tous les droits et restrictions du/des titre(s) existant(s) doivent être pris en compte dans les titres créés dans la demande.', 'NOT USED BY SOLA STATE LAND', '#{id}(application_id) is requested');
