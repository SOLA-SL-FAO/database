...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('bulk-spatial-name-unique', 'bulk-spatial-name-unique', 'sql', 'Cadastre objects with must have unique names.::::Кадастровые объекты должны иметь уникальные коды.', NULL, '#{id}(transaction_id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-must-have-parties', 'rrr-must-have-parties', 'sql', 'The _$rrr_type interest on _$property_name must have a rightholder specified', NULL, '');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('area-check-percentage-newofficialarea-calculatednewarea', 'area-check-percentage-newofficialarea-calculatednewarea', 'sql', 'The difference between the official parcel area and its calculated area should be less than 1%; _$parcel_list', 'Updated for State Land BR-3', '#{id}(cadastre.cadastre_object.id) is requested. 
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('new-cadastre-objects-do-not-overlap', 'new-cadastre-objects-do-not-overlap', 'sql', 'New parcel polygons must not overlap', 'Updated for State Land BR-4', '#{id}(transaction_id) is requested. Check the union of new co has the same area as the sum of all areas of new co-s, which means the new co-s don''t overlap');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-cadastre-object', 'ba_unit-has-cadastre-object', 'sql', 'Property must have an associated parcel', NULL, '#{id}(administrative.ba_unit.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br4-check-sources-date-not-in-the-future', 'application-br4-check-sources-date-not-in-the-future', 'sql', 'Document date must not be in the future; _$doc_list', NULL, 'Checks the date of the document as recorded at lodgement (source.recordation) and checks it is not a date in the future');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br7-check-sources-have-documents', 'application-br7-check-sources-have-documents', 'sql', 'Documents lodged with a job should have a scanned image file (or other source file) attached; _$doc_list', 'Updated for State Land', 'Checks that each document lodged with the application has a scanned image file (or other digital source file) stored in the SOLA database. To remedy the failure of the business rule add the scanned image to the document record through the Document Tab in the Application form or use the Document Toolbar item in the Main form.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-on-approve-check-services-status', 'application-on-approve-check-services-status', 'sql', 'All tasks in the job must have the status Cancelled or Completed.', NULL, 'Checks the service.status_code for all instances of service related to the application');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('cancel-title-check-rrr-cancelled', 'cancel-title-check-rrr-cancelled', 'sql', 'All current interests on the property being disposed must be extinguished by this job', NULL, '#{id}(application_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br3-check-properties-are-not-historic', 'application-br3-check-properties-are-not-historic', 'sql', 'All the titles identified for the application must be current.::::Все права собственности, относящиеся к заявлению должны иметь текущий (активный) статус.::::جميع سندات الملكية داخل الطلب يجب ان  تكون حالية::::Tous les titres identifiés pour la demande doivent être courants.', 'NOT USED BY SOLA STATE LAND', 'Checks the title reference recorded at lodgement against titles in the database and if there is a ba_unit record it checks if it is current (PASS)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-on-approve-check-public-display', 'application-on-approve-check-public-display', 'sql', 'The publication period must be completed.::::Период публикации должен быть завершен.::::يجب استكمال فترة النشر::::La période de publication doit être exécutée.', 'NOT USED BY SOLA STATE LAND', 'Checks the completion of the public display period for all instances of systematic registration service related to the application');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('app-check-title-ref', 'app-check-title-ref', 'sql', 'Invalid identifier for title::::Неверный идентификатор права собственности::::معرف السند غير صحيح::::Identifiant invalide pour le titre', 'NOT USED BY SOLA STATE LAND', '');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('app-allowable-primary-right-for-new-title', 'app-allowable-primary-right-for-new-title', 'sql', 'An allowable primary right (ownership, apartment, State ownership, lease) must be identified for a new title::::Одно из допустимых прав собственности такое как - право собственности, право собственности на квартиру, государственное право собственности, аренда, должно быть зарегистрировано для нового объекта недвижимости.::::الحق الاساسي المسموح به  (المالك, الشقة, مالك العقار, الايجار ) يجب تحديده لسند ملكية جديد::::Tous les droits principaux autorisés (propriété, appartement, propriété de l''Etat, bail) doivent être identifiés pour le nouveau titre', 'NOT USED BY SOLA STATE LAND', '#{id}(application.application.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-verifies-identification', 'application-verifies-identification', 'sql', 'Personal identification verification should be attached to the application.::::Персональный идентификационный документ должен быть прикреплен к заявлению.::::يجب ارفاق وثائق التعريف الشخصية مع الطلب::::La vérification de l''identité personnelle doit être attachée à la demande.', 'NOT USED BY SOLA STATE LAND', '#{id}(application.application.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('app-other-app-with-caveat', 'app-other-app-with-caveat', 'sql', 'The identified property is affected by another live application that includes a service to register a caveat. An application with a cancel or waiver/vary caveat service must be registered before this application can proceed.::::Выбранная недвижимость используется в другом заявлении, находящемся в обработке и включающее регистрацию ареста. Заявление с услугой отмены ареста должно быть зарегистрировано для того чтобы продолжить с текущим заявлением.::::هناك طلب أخر على الملكية المحددة والذي يحتوي  خدمة فيها قيود على نفس الملكية. يجب التنازل او الغاء القيود قبل امكانية الاستمرار::::La propriété identifiée est affectée par une autre demande en cours qui inclue un service d''enregistrement de caveat. Une demande de service d''annulation ou de variation/résiliation du caveat doit être enregistrée avant de pouvoir procéder à cette demande.', 'NOT USED BY SOLA STATE LAND', '#{id}(application.application.id) is requested.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('spatial-unit-group-name-unique', 'spatial-unit-group-name-unique', 'sql', 'Spatial unit groups must be unique.::::Пространственные группы должны быть уникальны.', 'NOT USED BY SOLA STATE LAND', 'There is no parameter required.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('public-display-check-baunit-has-co', 'public-display-check-baunit-has-co', 'sql', 'All property must have an associated cadastre object.::::Все объекты недвижимости должны иметь соответствующие кадастровые объекты.', 'NOT USED BY SOLA STATE LAND', '#{lastPart}(name_lastpart) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-compatible-cadastre-object', 'ba_unit-has-compatible-cadastre-object', 'sql', 'Title should have compatible parcel (or cadastre object) description (appellation)::::Недвижимость должна иметь совместимый тип земельного участка.::::سند الملكية يجب ان يحتوي على وصف\ اسم   قطعة متوافقة::::Le titre doit avoir un descriptif (appellation) de parcelle (ou objet cadastre) compatible.', 'NOT USED BY SOLA STATE LAND', '#{id}(administrative.ba_unit.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('newtitle-br22-check-different-owners', 'newtitle-br22-check-different-owners', 'sql', 'Owners of new titles should be the same as owners of underlying titles::::Владельцы новых объектов недвижимости должны быть такие же как в родительских объектах.::::المالكون في سند الملكية الجديد يجب ان يكونوا نفس المالكين من السندات السابقة::::Les propriétaires des nouveaux titres doivent être les mêmes que les propriétaires des titres sous-jacents.', 'NOT USED BY SOLA STATE LAND', '#{id}(baunit_id) is requested.
Check that new title owners are the same as underlying titles owners (Give WARNING if > 0)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('cadastre-redefinition-target-geometries-dont-overlap', 'cadastre-redefinition-target-geometries-dont-overlap', 'sql', 'New polygons do not overlap with each other.::::Новые полигоны не пересекаются друг с другом.::::المضلعات الجديدة لا يجب ان تتداخل::::Les nouveaux polygones ne doivent pas se superposer.', 'NOT USED BY SOLA STATE LAND', '#{id} is the parameter asked. It is the transaction id.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('spatial-unit-group-inside-other-spatial-unit-group', 'spatial-unit-group-inside-other-spatial-unit-group', 'sql', 'Spatial unit groups that are not of the top hierarchy must be spatially inside another spatial unit group with hierarchy which is a level up. Tolerance of 0.5 m is applied.::::Пространственные группы, которые не находятся на самой вершине иерархии, должны быть расположены внутри других пространственных групп с более высшим уровнем иерархии. Погрешность может составлять 0.5 м.', 'NOT USED BY SOLA STATE LAND', 'There is no parameter required.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('area-check-percentage-newareas-oldareas', 'area-check-percentage-newareas-oldareas', 'sql', 'The difference between the total of the new parcels official areas and the total of the old parcels official areas should not be greater than 0.1%::::Разница между общей официальной площадью новых участков и площадью старых участков не должна превышать 0.1%.::::الفرق بين مجموع مساحات  القطع الجديدة الرسمية  ومجموع المساحات السابقة للقطع القديمة يجب ان لا يتجاوز 0.1 %::::La différence entre la superficie totale officielle des nouvelles parcelles et la superficie totale officielle des anciennes parcelles ne doit pas être supérieur à 0.1%.', 'NOT USED BY SOLA STATE LAND', '');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('cadastre-redefinition-union-old-new-the-same', 'cadastre-redefinition-union-old-new-the-same', 'sql', 'The union of the new polygons must be the same as the union of the old polygons::::Объединение новых полигонов должно быть таким же как объединение старых полигонов.::::الاتحاد من المضلعات الجديدة يجب أن تكون نفس الاتحاد من المضلعات القديمة::::L''union des nouveaux polygones doit être le même que l''union des anciens polygones.', 'NOT USED BY SOLA STATE LAND', '#{id} is the parameter asked. It is the transaction id.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('new-cadastre-objects-present', 'new-cadastre-objects-present', 'sql', 'New cadastral objects must be defined::::Новые кадастровые объекты должны быть определены.::::يجب تحديد كائن مساحة جديد::::Les nouveaux objets cadastres doivent être définis.', 'NOT USED BY SOLA STATE LAND', '#{id}(transaction_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('target-and-new-union-the-same', 'target-and-new-union-the-same', 'sql', 'The union of new parcel polygons is the same with the union of the target parcel polygons::::Объединение полигонов новых участков должно быть таким же как форма полигонов целевых участков.::::الاتحاد بين مضلعات القطعة الجديدة يساوي الاتحاد بين مضلعات القطعة المستهدفة::::L''union des polygones des nouvelles parcells est le même que l''union des polygones des parcelles cibles.', 'NOT USED BY SOLA STATE LAND', '#{id}(transaction_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('target-parcels-check-isapolygon', 'target-parcels-check-isapolygon', 'sql', 'The union of the target parcels must be a polygon::::Объединение целевых участков должно быть полигоном.::::الاتحاد بين القطع يجب ان يكون مضلع::::L''union des parcelles cibles doit être un polygone.', 'NOT USED BY SOLA STATE LAND', '#{id}(cadastre.cadastre_object.transaction_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('target-parcels-check-nopending', 'target-parcels-check-nopending', 'sql', 'There should be no pending changes for any of target parcels::::Целевые участки не должны иметь каких-либо незавершенных изменений.::::يجب ان لا يوجد اية تغييرات معلقة على القطعة المستهدفة::::Il ne doit pas y avoir de changement en attente pour aucune des parcelles cibles.', 'NOT USED BY SOLA STATE LAND', '#{id}(cadastre.cadastre_object.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('target-parcels-present', 'target-parcels-present', 'sql', 'Target parcel(s) must be selected::::Целевые участки должны быть выбраны.::::يجب اختيار القطعة المستهدفة::::Le(s) parcelle(s) doivent être sélectionnées.', 'NOT USED BY SOLA STATE LAND', '#{id}(transaction_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('survey-points-present', 'survey-points-present', 'sql', 'There are at least 3 survey points present::::По крайней мере должны быть определены 3 точки съемки.::::هناك على الاقل ثلاث نقاط مساحة موجودة::::Il doit y avoir au moins 3 points de levé.', 'NOT USED BY SOLA STATE LAND', '#{id}(transaction_id) is requested. Check there are survey points attached with the cadastre change.
 At least 3 points has to be attached to complete a polygon.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-several-mortgages-with-same-rank', 'ba_unit-has-several-mortgages-with-same-rank', 'sql', 'The rank of a new mortgage must not be the same as an existing mortgage registered on the same title::::Рейтинг новой ипотеки не должен быть таким же как у существующей ипотеки для данной недвижимости.::::رتبة الرهن يجب ان لا تساوي نفس رتبة الرهن  الحالي::::Le rang de la nouvelle hypothèque ne doit pas être le même qu''une hypothèque existante enregistrée sur le même titre.', 'NOT USED BY SOLA STATE LAND', '#{id}(administrative.rrr.id) is requested.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('spatial-unit-group-not-overlap', 'spatial-unit-group-not-overlap', 'sql', 'Spatial unit groups of the same hierarchy must not overlap with each other. Tolerance of 0.5 m is applied.::::Пространственные группы одной и той же иерархии не должны пересекаться друг с другом. Погрешность не должна превышать 0.5 м', 'NOT USED BY SOLA STATE LAND', 'There is no parameter required.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-has-pending', 'rrr-has-pending', 'sql', 'There are no other pending actions on the rights and restrictions being changed or removed on this application::::Нет никаких изменений в правах и ограничениях, сделанных из текущего заявления::::لا يوجد حركات بحاجة لتنفيذ على الحقوق او القيود لهذا الطلب::::Il n''y a pas d''autre actions en attente sur les droits et restrictions en cours de changement ou supprimé de cette application.', 'NOT USED BY SOLA STATE LAND', '#{id}(administrative.rrr.id) is requested. It checks if for the target rrr there is already a pending edit or record.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-has-caveat', 'ba_unit-has-caveat', 'sql', 'Caveat should not prevent registration proceeding.::::Арест не должен ограничивать дальнейшую регистрацию.::::القيود لا يجب ان تعطل عملية التسجيل::::Un caveat ne doit pas empêcher de procéder à l''enregistrement.', 'NOT USED BY SOLA STATE LAND', '#{id}(administrative.rrr.id) is requested.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('source-attach-in-transaction-no-pendings', 'source-attach-in-transaction-no-pendings', 'sql', 'Document (source file) must not be duplicated::::Документ не должен дублироваться.::::يجب عدم تكرار الوثيقة  (ملف المصدر)::::Le document (fichier source) ne doit pas être dupliqué.', 'NOT USED BY SOLA STATE LAND', '#{id}(source.source.id) is requested. It checks if the source has already a record with the status pending.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('source-attach-in-transaction-allowed-type', 'source-attach-in-transaction-allowed-type', 'sql', 'Document to be registered must have an allowable and current source type::::Документы для регистрации должны иметь допустимый тип.::::الوثيقة المراد تسجيلها يجب ان يكون لها نوع مصدر حالي مسموح به::::Le document à enregistrer doit avoir un type de source courant et disponible.', 'NOT USED BY SOLA STATE LAND', '#{id}(source.source.id) is requested. It checks if the source has a type which has the is_for_registration attribute true.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba_unit-spatial_unit-area-comparison', 'ba_unit-spatial_unit-area-comparison', 'sql', 'The difference between the property area (_$property_area) and the parcel area (_$parcel_area) must be less than 1%', 'NOT USED BY SOLA STATE LAND', '#{id}(administrative.ba_unit.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba-unit-has-spatial-parcels', 'ba-unit-has-spatial-parcels', 'sql', 'Parcels on _$property_name have not been mapped; _$parcel_list', 'State Land BR-7', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba-unit-has-notes-to-action', 'ba-unit-has-notes-to-action', 'sql', 'Notes on _$property_name require action; _$notes_list', 'State Land BR-6', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('parcel-name-duplicated', 'parcel-name-duplicated', 'sql', '_$rule_count duplicated parcel name(s); _$parcel_list', 'State Land BR-5', 'Parameters: #{id} (transaction.transaction.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('property-compenstation-comparison', 'property-compenstation-comparison', 'sql', 'Final compenstation is more than %10 above the initial offer; _$property_list', 'State Land BR-9', 'Parameters: #{id} (application.service.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('ba-unit-has-land-use', 'ba-unit-has-land-use', 'sql', '_$property_name must be linked to parcels that specify land use', 'State Land BR-11', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-has-conditions', 'rrr-has-conditions', 'sql', '_$rrr_type on _$property_name should have conditions recorded', 'State Land BR-19', 'Parameters: #{id} (administrative.ba_unit.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br8-check-has-services', 'application-br8-check-has-services', 'sql', 'A job must have at least one task', NULL, 'Checks that an application has at least one service. When this rule fails you should add a service to the application or cancel the application.');
