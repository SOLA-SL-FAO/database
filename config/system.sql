...
INSERT INTO config_panel_launcher (code, display_value, description, status, launch_group, panel_class, message_code, card_name) VALUES ('publicDisplay', 'Public Display Panel', NULL, 'c', 'generalServices', 'org.sola.clients.swing.desktop.cadastre.MapPublicDisplayPanel', 'cliprgs108', 'MAP_PUBLIC_DISPLAY_PANEL');
